...
import { diffObject, isObjEmpty } from '@libs/global/utils';
import { SUBSCRIPTION_PLANS_APP_CACHE_KEY } from '@app/store-config/constants';
...
export class SubscriptionPlansService {
  private readonly API_CACHE_KEYS = [
    ...
    '/v1/dash/store-config/subscription-plans',
  ];
